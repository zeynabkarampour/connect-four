...
Create board based on WIDTH and HEIGHT
Create drop area as 1 WIDTH of board
Append board and drop area to DOM
Handle click event
...
function handleClick(evt) {
  ...
  if (board[0].every(cell => cell !== null)) {
    return endGame('The game is tied, there is no winner!')
  }
